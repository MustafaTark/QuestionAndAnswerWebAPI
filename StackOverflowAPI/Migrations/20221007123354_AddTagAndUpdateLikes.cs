...
{
    public partial class AddTagAndUpdateLikes : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LikesToComment_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikesToQuestion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LikesToQuestion_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LikesToComment_CommentId",
                table: "LikesToComment",
                column: "CommentId");

            migrationBuilder.CreateIndex(
                name: "IX_LikesToComment_UserId",
                table: "LikesToComment",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_LikesToQuestion_QuestionId",
                table: "LikesToQuestion",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_LikesToQuestion_UserId",
                table: "LikesToQuestion",
                column: "UserId");
